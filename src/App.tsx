...
export default function App() {
  ...
  const employeeWorkspace = <div className="space-y-6"><EmployeeDataLinkManager currentUser={currentUser} selectedTenantId={selectedTenantId} /><EmployeeDb currentUser={currentUser} selectedTenantId={selectedTenantId} /></div>;
