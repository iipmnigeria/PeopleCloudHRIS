...
import { Banknote, Calculator, CalendarCheck2, FileText, ShieldCheck } from 'lucide-react';
...
export default function GlobalPayrollWorkspace(props: any) {
  ...
  const [tab, setTab] = useState<'engine' | 'approval' | 'payslips' | 'attendance' | 'bank'>(isEmployee ? 'payslips' : 'engine');
